...
Based on our memory technology exploration, we now provide an overview of BROM
...
desirable characteristic of BROM is that it provides prioritized access to the
...
performance overhead. The rest of this section describes the BROM design, which
...
hardware design: num of levels; memory technology of each level; size of each level
...
performance opt: lut long enough but not too long (num of entries, bits per entry)
