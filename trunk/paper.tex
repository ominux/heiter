...
and L4 caches respectively. As a result, the overall provided bandwidth curve of
the on-chip memory system will appear to be an envelope line of all the
available memory technologies as shown in
Figure~\ref{fig:pbw-envelope}.\vspace{5pt}
...
When the system is initially powered on, 
